          ...
          <Card className="p-8">
            ...
            <div className="space-y-8">
                ...
                <div className="grid grid-cols-2 gap-4 bg-slate-50 p-6 rounded-xl border border-slate-100">
                    ...
                    <div>
                        <span className="block text-xs font-bold text-slate-400 uppercase">Ball Type</span>
                        <span className="font-bold text-slate-800">{BALL_TYPE_OPTIONS.find(c => c.value === ballType)?.label}</span>
                    </div>
                    <div>
                        <span className="block text-xs font-bold text-slate-400 uppercase">Match Type</span>
                        <span className="font-bold text-slate-800">{MATCH_TYPE_OPTIONS.find(c => c.value === matchType)?.label}</span>
                    </div>
                    <div>
